...
public class Employe {
    ...
    * avec NOM_BIDON ansi que la date d'embauche laDate si celle-ci n'est pas
   ...
   /**
    * Retourne sous forme de String les informations sur l'employe (Redefinition
    * de la methode toString de la classe Object.)
    */
